...
public class ImageJUtils {
	...
	public static ByteProcessor getByteProcessorFromShortImage(ShortImage si,
	...
	public static ImageStack getShortImageStackFromShortImageArray(
			ShortImage[] imageArray) {
		ImageStack ims = new ImageStack(imageArray[0].getWidth(),
				imageArray[0].getHeight());
	...
	public static ImageStack getByteImageStackFromShortImageArray(
			ShortImage[] imageArray) {
	...
	public static ImageStack getByteImageStackFromShortImageArray(
			ShortImage[] imageArray, int windowCenter, int widowWidth) {
		ImageStack ims = new ImageStack(imageArray[0].getWidth(),
				imageArray[0].getHeight());

		for (ShortImage si : imageArray) {
			ims.addSlice(ImageJUtils.getByteProcessorFromShortImage(si,
					windowCenter, widowWidth));
		}
